...
Install the following tools before beginning the course:
...
- Thunder Client.
- Live Server.
- Flow Icons or another icon extension.
...
Run these commands in a terminal to verify the main installations:
